...
Batch Analysis accepts up to 50 Cisco IOS and Aruba AOS-CX configurations in a
single request. Device identifiers must be non-empty and unique, and every
device must explicitly select a supported vendor.
